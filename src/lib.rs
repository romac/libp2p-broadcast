...
use libp2p::swarm::{ConnectionId, NetworkBehaviour, NotifyHandler, OneShotHandler, ToSwarm};
...
impl NetworkBehaviour for Broadcast {
    ...
    fn on_connection_handler_event(
        ...
        peer: PeerId,
        _: ConnectionId,
        msg: Result<HandlerEvent, libp2p::swarm::StreamUpgradeError<std::io::Error>>,
    ) {
        use HandlerEvent::*;
        use Message::*;
